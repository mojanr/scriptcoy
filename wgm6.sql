...
insert  into `pengelola`(`username`,`password`,`tipe`,`namaPengelola`) values ('admin','admin','Administrator','admin'),('alahawaw','alahawaw','Administrator','ojan'),('goduz','goduz','Administrator','Hari Gunawan'),('gunawan','goduz','Branding And Strategy','Hari Gunawan'),('ojan','ojan','Branding And Strategy','ojan');
