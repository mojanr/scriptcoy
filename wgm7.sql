...
insert  into `pengelola`(`username`,`password`,`tipe`,`namaPengelola`) values ('alahawaw','alahawaw','Administrator','ojan'),('coba','coba','Administrator','coba'),('goduz','goduz','Administrator','Hari Gunawan'),('gunawan','goduz','Branding And Strategy','Hari Gunawan'),('ojan','ojan','Branding And Strategy','ojan'),('wgmadmin','wgmadminsecpass','Administrator','admin');
...
CREATE TABLE `pesanan` (
  ...
  `status` enum('Sudah Dikonfirmasi','Menunggu Konfirmasi','Batal') DEFAULT NULL,
...
insert  into `pesanan`(`idPesanan`,`namaPemesan`,`noTelp`,`email`,`alamat`,`tglPesan`,`tglDeadline`,`totalHarga`,`status`,`finishing`,`orientasi`,`username`) values ('WGM20180112002','asdf','asdf','asdf','fasdf','2018-01-12','2018-03-12',6805000,'Sudah Dikonfirmasi','Gloss','Left Handed','ojan'),('WGM20180114003','asdf','asdf','asf','sadf','2018-01-14','2018-02-14',6805000,'Sudah Dikonfirmasi','Gloss','Left Handed','ojan'),('WGM20180114004','asdf','asdf','asdf','asdf','2018-01-14','2018-03-14',6805000,'Menunggu Konfirmasi','Gloss','Right Handed',NULL),('WGM20180114005','ggg','gg','gg','gg','2018-01-14','2018-03-14',6805000,'Menunggu Konfirmasi','Satin','Right Handed',NULL),('WGM20180115006','fauzan','08322312356','fauzan@gmail.com','Jl. sukarajin 2','2018-01-15','2018-02-15',7255000,'Menunggu Konfirmasi','Gloss','Right Handed',NULL),('WGM20180115007','hari andrian','082321152723','fauzan@yahoo.co.id','jalan cicukang ','2018-01-15','2018-02-15',7255000,'Menunggu Konfirmasi','Gloss','Right Handed',NULL),('WGM20180115008','purba','0123456789','babackp@yahoo.com','jalan','2018-01-15','2018-02-15',4400000,'Menunggu Konfirmasi','Gloss','Right Handed',NULL),('WGM20180129009','tampan','1234','tampan@email.com','jlan','2018-01-29','2018-03-29',6900000,'Menunggu Konfirmasi','Gloss','Right Handed',NULL),('WGM20180129010','asdf','123','asf@email.com','asfsadf','2018-01-29','2018-03-29',6900000,'Menunggu Konfirmasi','Gloss','Right Handed',NULL),('WGM20180129011','asdf','123','asdf@email.com','asdfasdf','2018-01-29','2018-03-29',7250000,'Menunggu Konfirmasi','Gloss','Right Handed',NULL),('WGM20180129012','asdf','123','asdf@emailc.om','asasdf','2018-01-29','2018-03-29',7250000,'Menunggu Konfirmasi','Gloss','Right Handed',NULL),('WGM20180130013','asdf','123','asdf@email.com','asdfasdf','2018-01-30','2018-03-30',7255000,'Menunggu Konfirmasi','Gloss','Right Handed',NULL);
